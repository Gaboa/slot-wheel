...
export default {
    ...
    methods: {
        handleChange(e){
            this.$root.$emit(`${this.$props.details[0].id}_changed`,
            {
                type:`${this.$props.details[0].id.toUpperCase()}`, 
...
<style scoped>
    ...
    .checkbox__input:checked~.checkbox__label {
        border-width: 0.9vw;
        background: #5FD17A;
        box-shadow: 2px 2px 4px 0 rgba(0, 0, 0, 0.2), inset 2px 2px 4px 0 rgba(0, 0, 0, 0);
    }
