...
const common = [
    ...
    { name: 'wallet', url: 'machine/elements/wallet.json' },
    { name: 'purse',  url: 'machine/elements/purse.json' },
    { name: 'pack',   url: 'machine/elements/pack.json' },
    { name: 'bag',    url: 'machine/elements/bag.json' },
    { name: 'wild',   url: 'machine/elements/wild.json' },
    { name: 'dollar', url: 'machine/elements/dollar.json' },
    { name: 'key',    url: 'machine/elements/key.json' },
    { name: 'top',    url: 'machine/elements/top.json' },
